...
import { COLLECTION_LIST, GET_DASHBOARD_ALL, GET_DASHBOARD_BY_ID } from '../../graphQl/query';
...
const Dashboard = () => {
  ...
  const [getDashboardAll, { loading: loadingDashboardAll, error: errorDashboardAll, data: dataDashboardAll }] =
