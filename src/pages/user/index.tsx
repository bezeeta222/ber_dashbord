...
import { Card as MuiCard, Divider as MuiDivider, Grid, Paper as MuiPaper, Typography } from '@mui/material';
...
const columns: GridColDef[] = [
  ...
  // { field: "dateJoined", headerName: "Date Joined", width: 200 },
  {
    ...
    width: 200,
    valueFormatter: (params: any) => new Date(params.value).toLocaleDateString('en-US') // Format date as desired
  }
];
...
const User = () => {
  ...
  const [getPointList, { loading: loadingPointList, error: errorPointList, data: dataPointList }] = useLazyQuery(POINT_LIST);
